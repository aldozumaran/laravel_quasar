    ...
    <div class="fixed fixed-center bg-grey-1 text-white">
        <form v-on:submit.prevent="onSubmit()">
            <q-card square class="flex-center text-center" style="width: 400px; padding:50px">
                ...
                <q-card-separator/>
                <div class="text-left">
                    <q-input id="email" type="text" v-model.trim="form.email" float-label="Email" required
                             autofocus/>
                    <q-input id="password" type="password" v-model="form.password" float-label="Password" required/>
                    <br>
                </div>
                <q-card-actions>
